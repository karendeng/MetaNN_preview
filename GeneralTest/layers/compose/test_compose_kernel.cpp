...
void test_compose_kernel14()
{
    ...
    using InstantiationComp1 = InstantiatedSublayerContainer<InstantiatedSublayer<Tag6, AddLayer<PolicyContainer<PFeedbackOutput>>>,
    ...
    using Policy2 = PolicyContainer<PTanhAction, SubPolicyContainer<Tag3, PRowVecInput>>;
    using Instantiation2 = SublayerInstantiation<Policy2, check1, InterConnects>::type;
    using InstantiationComp2 = InstantiatedSublayerContainer<InstantiatedSublayer<Tag6, AddLayer<PolicyContainer<PTanhAction>>>,
                                                             ...
                                                             InstantiatedSublayer<Tag3, BiasLayer<PolicyContainer<PRowVecInput, PTanhAction>>>,
    ...
    using InstantiationComp3 = InstantiatedSublayerContainer<InstantiatedSublayer<Tag6, AddLayer<PolicyContainer<PTanhAction>>>,
                                                             InstantiatedSublayer<Tag1, AddLayer<PolicyContainer<PTanhAction>>>,
    ...
    using InstantiationComp4 = InstantiatedSublayerContainer<InstantiatedSublayer<Tag6, AddLayer<PolicyContainer<PTanhAction>>>,
                                                             InstantiatedSublayer<Tag1, AddLayer<PolicyContainer<PTanhAction>>>,
                                                             InstantiatedSublayer<Tag2, ElementMulLayer<PolicyContainer<PTanhAction>>>,
...
void test_compose_kernel15()
{
    cout << "Test compose kernel case 15...\t";
    using namespace MetaNN::NSComposeKernel;

    using check1 = SublayerTupleType<InstantiatedSublayer<Tag6, AddLayer<PolicyContainer<PTanhAction>>>,
                                     InstantiatedSublayer<Tag1, AddLayer<PolicyContainer<PTanhAction>>>,
                                     InstantiatedSublayer<Tag2, ElementMulLayer<PolicyContainer<PTanhAction>>>,
                                     InstantiatedSublayer<Tag3, BiasLayer<PolicyContainer<PUpdate, PTanhAction>>>,
                                     InstantiatedSublayer<Tag4, TanhLayer<PolicyContainer<PTanhAction>>>,
                                     InstantiatedSublayer<Tag5, AddLayer<PolicyContainer<PTanhAction, PFeedbackOutput>>>>;
    using comp_tag1 = std::tuple<Tag6, Tag1, Tag2, Tag3, Tag4, Tag5>;
    using comp_layer1 = std::tuple<AddLayer<PolicyContainer<PTanhAction>>,
                                   AddLayer<PolicyContainer<PTanhAction>>,
                                   ElementMulLayer<PolicyContainer<PTanhAction>>,
                                   BiasLayer<PolicyContainer<PUpdate, PTanhAction>>,
                                   TanhLayer<PolicyContainer<PTanhAction>>,
                                   AddLayer<PolicyContainer<PTanhAction, PFeedbackOutput>>>;
    static_assert(std::is_same<check1::TagTuple, comp_tag1>::value, "Check Error");
    static_assert(std::is_same<check1::InstTuple, comp_layer1>::value, "Check Error");
    cout << "Done" << endl;
}
}
