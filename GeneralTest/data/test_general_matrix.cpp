...
void TestMatrix3()
{
    cout << "Test general matrix case 3...\t";
    static_assert(IsBatchMatrix<Batch<Matrix<CheckElement, CheckDevice>>>, "Test Error");
    static_assert(IsBatchMatrix<Batch<Matrix<CheckElement, CheckDevice>> &>, "Test Error");
    static_assert(IsBatchMatrix<Batch<Matrix<CheckElement, CheckDevice>> &&>, "Test Error");
    static_assert(IsBatchMatrix<const Batch<Matrix<CheckElement, CheckDevice>> &>, "Test Error");
    static_assert(IsBatchMatrix<const Batch<Matrix<CheckElement, CheckDevice>> &&>, "Test Error");

    auto rm1 = Batch<Matrix<CheckElement, CheckDevice>>(10, 20);
