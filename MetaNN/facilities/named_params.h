...
public:
    static auto Create()
    {
        using type = typename NSNamedParams::Create_<sizeof...(TParameters), Values>::type;
        return type{};
    }
};
}
