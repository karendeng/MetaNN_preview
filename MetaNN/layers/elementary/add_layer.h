...
namespace NSAddLayer
{
template <bool IsFeedbackOutput, typename TGrad,
          std::enable_if_t<IsFeedbackOutput>* = nullptr>
inline auto FeedbackOutHelper(TGrad&& p_grad)
{
...
template <bool IsFeedbackOutput, typename TGrad,
          std::enable_if_t<!IsFeedbackOutput>* = nullptr>
inline auto FeedbackOutHelper(TGrad&&)
{
...
public:
    ...
    {
        return NSAddLayer::FeedbackOutHelper<IsFeedbackOutput>(std::forward<TGrad>(p_grad));
    }
};
}
